  ...
  return (
    <div className="py-4 text-gray-500 dark:text-gray-400">
      <a className=" text-gray-900 dark:text-gray-200" href="/dashboard">
        {mode === "dark" ? (
          <img src={logoLight} alt="kachabazar" width="135" className="pr-6" />
        ) : (
          <img src={logoDark} alt="kachabazar" width="135" className="pr-6" />
        )}
      </a>
      <ul className="mt-8">
        {sidebar.map((route) =>
            ...
            <li className="relative" key={route.name}>
              ...
              >
                <Route path={route.path} exact={route.exact}>
                  <span
                    className="absolute inset-y-0 right-0 w-1 bg-emerald-500 rounded-tr-lg rounded-br-lg"
                    aria-hidden="true"
                  ></span>
                </Route>
